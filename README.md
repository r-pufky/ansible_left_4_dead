...
Tasks are gated by feature flags and executed in the following order.
  ...
  Step | Flag                      | Notes
 ------|---------------------------|-------
  1    | left_4_dead_flg_container | Deploy container specific settings.
  2    | left_4_dead_flg_cdn       | Statically set Steam CDN IP.
  3    | left_4_dead_flg_update    | Update server on launch or if already installed.
  4    | left_4_dead_flg_config    | Set configuration files.
  5    | left_4_dead_flg_metamod   | Install Metamod.
  6    | left_4_dead_flg_sourcemod | Install Sourcemod.
